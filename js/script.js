...
var audio = new Audio("");
document.querySelector("#hibaldicon").addEventListener
("click", function() {
    console.log("hi");
	audio.src = document.getElementById("audiohibald").src;
...
document.querySelector("#birdicon").addEventListener
("click", function() {
    console.log("hi");
	audio.src = document.getElementById("#audiobird").src;
...
document.querySelector("#workicon").addEventListener
("click", function() {
    console.log("hi");
	audio.src = document.getElementById("#audiowork").src;
...
document.querySelector("#bookedicon").addEventListener
("click", function() {
    console.log("hi");
	audio.src = document.getElementById("#audiobooked").src;
   
  audio.play();
  
});

document.querySelector("#yupicon").addEventListener
("click", function() {
    console.log("hi");
	audio.src = document.getElementById("#audioyup").src;
   
  audio.play();
  
});

document.querySelector("#stunningicon").addEventListener
("click", function() {
    console.log("hi");
	audio.src = document.getElementById("#audiostunning").src;
   
  audio.play();
  
});

document.querySelector("#happeningicon").addEventListener
("click", function() {
    console.log("hi");
	audio.src = document.getElementById("#audiohappening").src;
   
  audio.play();
  
});

document.querySelector("#gorgeousicon").addEventListener
("click", function() {
    console.log("hi");
	audio.src = document.getElementById("#audiogorgeous").src;
